...
if ( ! function_exists( 'restaurantz_import_custom_css' ) ) :
	 ...
	 * @since 3.5.0
	 */
	function restaurantz_import_custom_css() {
		...
		if ( ! is_wp_error( $return ) ) {
			...
			// Remove from theme.
			$options = restaurantz_get_options();
			$options['custom_css'] = '';
...
add_action( 'after_setup_theme', 'restaurantz_import_custom_css', 99 );
